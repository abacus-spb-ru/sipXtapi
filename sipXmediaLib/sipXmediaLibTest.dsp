...
# ADD CPP /nologo /MDd /W3 /Gm- /GR /GX /ZI /Od /I "..\sipXportLib\src\test" /I "..\sipXportLib\include" /I "include" /I "..\sipXtackLib\include" /I "src\test" /I "..\CPPUnit\include" /I "..\sipXsdpLib\include" /D "_DEBUG" /D "WIN32" /D "_CONSOLE" /D "SIPXTAPI_STATIC" /D "_MBCS" /FR /FD /GZ /GZ /Zm400 /c
...
# ADD LINK32 ..\sipXportLib\Debug\sipXportLibd.lib ..\sipXsdpLib\Debug\sipXsdpLibd.lib ..\sipXtackLib\Debug\sipXtackLibd.lib Debug\sipXmediaLibd.lib contrib\libspeex\lib\libspeexdsp.lib cppunitd_dll.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib wsock32.lib pcre.lib winmm.lib /nologo /subsystem:console /incremental:no /map /debug /machine:I386 /nodefaultlib:"msvcrt" /pdbtype:sept /libpath:"..\sipXmediaLib\contrib\libgsm\lib" /libpath:"..\CPPUnit\lib" /libpath:"..\sipXmediaLib\contrib\libspeex\lib"
...
SOURCE=.\src\test\mp\MprRecorderTest.cpp
# End Source File
# Begin Source File
